...
namespace Negocio {
    public class ManagerUsuarios {
        ...
        public List<Usuario> GetAll() {
            ...
            // Recorro el SqlDataReader, transformo el registro a objeto y agrego ese objeto a la lista de usuarios
        ...
        public void BorrarUsuario(Usuario usuarioActual) {
            // Creo el comando para ejecutar la sentencia SQL de DELETE, le asocio la Conexión también
        ...
        public void ActualizarUsuario(Usuario usuarioActual) {
            // Creo el comando para ejecutar la sentencia SQL de UPDATE, le asocio la Conexión también
            SqlCommand cmdActualizarUsuario = new SqlCommand("UPDATE usuarios SET tipo_doc = @tipo_doc, nro_doc = @nro_doc, fecha_nac = @fecha_nac, " +
                                               " apellido = @apellido, nombre = @nombre, direccion = @direccion, celular = @celular, " +
        ...
        public void AgregarUsuario(Usuario usuarioActual) {
            // Creo el comando para ejecutar la sentencia SQL de INSERT, le asocio la Conexión también
            SqlCommand cmdInsertarUsuario = new SqlCommand("INSERT INTO usuarios (tipo_doc, nro_doc, fecha_nac, apellido, nombre, direccion, " +
                                               "telefono, email, celular, usuario, clave) VALUES (@tipo_doc, @nro_doc, @fecha_nac, @apellido, " +
