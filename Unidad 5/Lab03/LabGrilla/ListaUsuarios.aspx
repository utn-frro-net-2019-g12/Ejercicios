...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <!-- OnSelectedIndexChanged="grdUsuarios_SelectedIndexChanged" OnSelecting="odsUsuarios_Selecting"  -->
    <title></title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="grdUsuarios" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="odsUsuarios" ShowFooter="True" OnRowCommand="grdUsuarios_RowCommand">
            <Columns>
