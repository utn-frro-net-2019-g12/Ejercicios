...
public partial class ListaUsuarios : System.Web.UI.Page {
    ...
    protected void grdUsuarios_RowCommand(object sender, GridViewCommandEventArgs e) {
        // Verificarmos que se ejecute lo siguiente solamente cuando lo produce a este evento el botón Insertar
        if (e.CommandName.ToLower() == "insertar") {
            TextBox cajaTexto;
            string textoActual;
            Negocio.Usuario usuarioNuevo = new Negocio.Usuario();

            // Busco el control y se lo asigno a la propiedad correspondiente del objeto Usuario
            ...
            // Ejemplo Date: "1990-10-20 21:34 PM";
